...
| **OneDrive Standalone Installer**<br><a href="https://support.microsoft.com/en-us/office/onedrive-release-notes-845dcf18-f921-435e-bf28-4e24b95e5fc0#OSVersion=Mac" style="text-decoration: none;"><small>_Release Notes_</small></a><br><br>_**Last Update:** `{get_standalone_package_detail(packages, 'OneDrive', 'last_updated')}`_<br> | **Version:**<br>`{get_standalone_package_detail(packages, 'OneDrive', 'short_version')}`<br><br>**Min OS:**<br>`{get_standalone_package_detail(packages, 'OneDrive', 'min_os')}`<br><br>**CFBundle ID:**<br>`com.microsoft.OneDrive` | <a href="{get_standalone_package_detail(packages, 'OneDrive', 'update_download')}"><img src="/images/OneDrive_512x512x32.png" alt="Download Image" width="80"></a> |
