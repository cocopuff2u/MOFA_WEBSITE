...
def parse_appstore_xml(file_path: str):
    """
    Parse the iOS App Store XML and return:
...
def generate_readme_content(global_last_updated: str, packages: list[dict]) -> str:
    """
    Generate minimal page focusing only on iOS App Store data.
    """
...
if __name__ == "__main__":
    # Source: iOS App Store XML
    xml_file_path = "repo_raw_data/ios_appstore_latest.xml"
    # Output page
    readme_file_path = "docs/minimal_ios_appstore.md"
