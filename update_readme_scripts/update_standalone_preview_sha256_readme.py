...
|----------------------|----------|------------------|
| **Word** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'Word', 'update_download')}"><img src="/images/MSWD_512x512x32.png" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Word', 'sha256')}` |
| **Excel** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'Excel', 'update_download')}"><img src="/images/XCEL_512x512x32.png" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Excel', 'sha256')}` |
| **PowerPoint** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'PowerPoint', 'update_download')}"><img src="/images/PPT3_512x512x32.png" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'PowerPoint', 'sha256')}` |
| **Outlook** (365/2021/2024) **Standalone Installer**| <a href="{get_standalone_package_detail(packages, 'Outlook', 'update_download')}"><img src="/images/Outlook_512x512x32.png" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Outlook', 'sha256')}` |
| **OneNote** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'OneNote', 'update_download')}"><img src="/images/OneNote_512x512x32.png" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'OneNote', 'sha256')}` |
