...
|----------------------|----------|------------------|
| **Word** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'Word', 'update_download')}"><img src="/images/2025/Word.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Word', 'sha256')}` |
| **Excel** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'Excel', 'update_download')}"><img src="/images/2025/Excel.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Excel', 'sha256')}` |
| **PowerPoint** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'PowerPoint', 'update_download')}"><img src="/images/2025/PowerPoint.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'PowerPoint', 'sha256')}` |
| **Outlook** (365/2021/2024) **Standalone Installer**| <a href="{get_standalone_package_detail(packages, 'Outlook', 'update_download')}"><img src="/images/2025/Outlook.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Outlook', 'sha256')}` |
| **OneNote** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'OneNote', 'update_download')}"><img src="/images/2025/OneNote.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'OneNote', 'sha256')}` |
| **Teams Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'Teams', 'update_download')}"><img src="/images/2025/Teams.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Teams', 'sha256')}` |
| **InTune Company Portal Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'Intune', 'update_download')}"><img src="/images/2021/Company_Portal.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Intune', 'sha256')}` |
| **Edge** <sup>_(Beta Channel)_</sup> | <a href="{edge_versions['beta']['full_update_download']}"><img src="/images/edge/edge_beta.webp" alt="Download Image" width="60"></a> | `{edge_versions['beta']['full_update_sha256']}` |
| **Edge** <sup>_(Dev Channel)_</sup> | <a href="{edge_versions['dev']['full_update_download']}"><img src="/images/edge/edge_dev.webp" alt="Download Image" width="60"></a> | `{edge_versions['dev']['full_update_sha256']}` |
| **Edge** <sup>_(Canary Channel)_</sup> | <a href="{edge_versions['canary']['full_update_download']}"><img src="/images/edge/edge_canary.webp" alt="Download Image" width="60"></a> | `{edge_versions['canary']['full_update_sha256']}` |
| **Defender For Endpoint Installer** | <a href="{get_standalone_package_detail(packages, 'Defender For Endpoint', 'update_download')}"><img src="/images/2025/Defender.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Defender For Endpoint', 'sha256')}` |
| **Defender For Consumer Installer** | <a href="{get_standalone_package_detail(packages, 'Defender For Consumers', 'update_download')}"><img src="/images/2025/Defender.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Defender For Consumers', 'sha256')}` |
| **Defender Shim Installer** | <a href="{get_standalone_package_detail(packages, 'Defender Shim', 'latest_download')}"><img src="/images/2025/Defender.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Defender Shim', 'sha256')}` |
...
| **AutoUpdate Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'MAU', 'update_download')}"><img src="/images/2019/AutoUpdate.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'MAU', 'sha256')}` |
...
| **Windows App Beta** | <a href="{get_standalone_package_detail(packages, 'Windows App Beta', 'update_download')}"><img src="/images/2025/Windows_App.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Windows App Beta', 'sha256')}` |
