...
| **Microsoft Copilot**<br><a href="https://learn.microsoft.com/en-us/copilot/microsoft-365/release-notes?tabs=mac" style="text-decoration: none;"><small>_Release Notes_</small></a><br><br>_**Last Update:**_<br>`{get_standalone_package_detail(packages, 'Copilot', 'last_updated')}`<br> | **Version:**<br>`{get_standalone_package_detail(packages, 'Copilot', 'short_version')}`<br><br>**Min OS:**<br>`{get_standalone_package_detail(packages, 'Copilot', 'min_os')}`<br><br>**CFBundle ID:**<br>`com.microsoft.m365copilot` | <a href="{get_standalone_package_detail(packages, 'Copilot', 'update_download')}"><img src="/images/2025/Copilot.webp" alt="Download Image" width="80"></a>|
