...
|----------------------|----------------------|--------------------------|--------------|
| **Microsoft** <sup>365/2021/2024</sup> **Office Suite Installer**<br><a href="https://learn.microsoft.com/en-us/officeupdates/release-notes-office-for-mac" style="text-decoration: none;"><small>_Release Notes_</small></a><br><sub>_(Includes Word, Excel, PowerPoint, Outlook, OneNote, OneDrive, and MAU)_</sub><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Microsoft Office Suite', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Microsoft Office Suite', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Microsoft Office Suite', 'min_os')}` | `com.microsoft.office` | <a href="https://go.microsoft.com/fwlink/?linkid=525133"><img src="/images/suite.png" alt="Download Image" width="80"></a> |
| **Microsoft** <sup>365/2021/2024</sup> **BusinessPro Suite Installer**<br><sub>_(Includes Word, Excel, PowerPoint, Outlook, OneNote, OneDrive, Teams, Defender Shim, and MAU)_</sub><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Microsoft BusinessPro Suite', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Microsoft BusinessPro Suite', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Microsoft BusinessPro Suite', 'min_os')}` | `com.microsoft.office` | <a href="https://go.microsoft.com/fwlink/?linkid=2009112"><img src="/images/suite.png" alt="Download Image" width="80"></a> |
| **Word** <sup>365/2021/2024</sup> **Standalone Installer**<br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Word', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Word', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Word', 'min_os')}` | `com.microsoft.word` | <a href="https://go.microsoft.com/fwlink/?linkid=525134"><img src="/images/MSWD_512x512x32.png" alt="Download Image" width="80"></a> |
...
| **Excel** <sup>365/2021/2024</sup> **Standalone Installer**<br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Excel', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Excel', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Excel', 'min_os')}` | `com.microsoft.excel` | <a href="https://go.microsoft.com/fwlink/?linkid=525135"><img src="/images/XCEL_512x512x32.png" alt="Download Image" width="80"></a> |
...
| **PowerPoint** <sup>365/2021/2024</sup> **Standalone Installer**<br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'PowerPoint', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'PowerPoint', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'PowerPoint', 'min_os')}` | `com.microsoft.powerpoint` | <a href="https://go.microsoft.com/fwlink/?linkid=525136"><img src="/images/PPT3_512x512x32.png" alt="Download Image" width="80"></a> |
...
| **Outlook** <sup>365/2021/2024</sup> **Standalone Installer**<br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Outlook', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Outlook', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Outlook', 'min_os')}` | `com.microsoft.outlook` | <a href="https://go.microsoft.com/fwlink/?linkid=2228621"><img src="/images/Outlook_512x512x32.png" alt="Download Image" width="80"></a>|
...
| **OneNote** <sup>365/2021/2024</sup> **Standalone Installer**<br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'OneNote', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'OneNote', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'OneNote', 'min_os')}` | `com.microsoft.onenote.mac` | <a href="https://go.microsoft.com/fwlink/?linkid=820886"><img src="/images/OneNote_512x512x32.png" alt="Download Image" width="80"></a> |
...
| **OneDrive Standalone Installer**<br><a href="https://support.microsoft.com/en-us/office/onedrive-release-notes-845dcf18-f921-435e-bf28-4e24b95e5fc0#OSVersion=Mac" style="text-decoration: none;"><small>_Release Notes_</small></a><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'OneDrive', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'OneDrive', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'OneDrive', 'min_os')}` | `com.microsoft.OneDrive` | <a href="https://go.microsoft.com/fwlink/?linkid=823060"><img src="/images/OneDrive_512x512x32.png" alt="Download Image" width="80"></a> |
...
| **Teams Standalone Installer**<br><a href="https://support.microsoft.com/en-us/office/what-s-new-in-microsoft-teams-d7092a6d-c896-424c-b362-a472d5f105de" style="text-decoration: none;"><small>_Release Notes_</small></a><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Teams', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Teams', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Teams', 'min_os')}` | `com.microsoft.teams2` | <a href="https://go.microsoft.com/fwlink/?linkid=2249065"><img src="/images/teams_512x512x32.png" alt="Download Image" width="80"></a> |
| **InTune Company Portal Standalone Installer**<br><a href="https://aka.ms/intuneupdates" style="text-decoration: none;"><small>_Release Notes_</small></a><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Intune', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Intune', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Intune', 'min_os')}` | `com.microsoft.CompanyPortalMac` | <a href="https://go.microsoft.com/fwlink/?linkid=853070"><img src="/images/companyportal.png" alt="Download Image" width="80"></a> |
| **InTune Company Portal App Only Installer**<br><a href="https://aka.ms/intuneupdates" style="text-decoration: none;"><small>_Release Notes_</small></a> <sub>_(Does Not Contain MAU)_</sub><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Intune', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Intune', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Intune', 'min_os')}` | `com.microsoft.CompanyPortalMac` | <a href="{get_standalone_package_detail(packages, 'Intune', 'app_only_update_download')}"><img src="/images/companyportal.png" alt="Download Image" width="80"></a> |
| **Edge Standalone Installer** <sup>_(Stable Channel)_</sup><br><a href="https://learn.microsoft.com/en-us/deployedge/microsoft-edge-relnote-stable-channel" style="text-decoration: none;"><small>_Release Notes_</small></a><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Edge', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Edge', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Edge', 'min_os')}` | `com.microsoft.edgemac` | <a href="https://go.microsoft.com/fwlink/?linkid=2093504"><img src="/images/edge_app.png" alt="Download Image" width="80"></a>|
| **Defender for Endpoint Installer**<br><a href="https://learn.microsoft.com/microsoft-365/security/defender-endpoint/mac-whatsnew" style="text-decoration: none;"><small>_Release Notes_</small></a><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Defender For Endpoint', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Defender For Endpoint', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Defender For Endpoint', 'min_os')}` | `com.microsoft.wdav` | <a href="https://go.microsoft.com/fwlink/?linkid=2097502"><img src="/images/defender_512x512x32.png" alt="Download Image" width="80"></a> |
| **Defender for Consumers Installer**<br><a href="https://learn.microsoft.com/microsoft-365/security/defender-endpoint/mac-whatsnew" style="text-decoration: none;"><small>_Release Notes_</small></a><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Defender For Consumers', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Defender For Consumers', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Defender For Consumers', 'min_os')}` | `com.microsoft.wdav` | <a href="https://go.microsoft.com/fwlink/?linkid=2247001"><img src="/images/defender_512x512x32.png" alt="Download Image" width="80"></a> |
...
| **Windows App Standalone Installer** <sup>_(Remote Desktop <img src="/images/microsoft-remote-desktop-logo.png" alt="Remote Desktop" width="15" style="vertical-align: middle; display: inline-block;" />)_</sup><br><a href="https://learn.microsoft.com/en-us/windows-app/whats-new?tabs=macos" style="text-decoration: none;"><small>_Release Notes_</small></a><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Windows App', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Windows App', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Windows App', 'min_os')}` | `com.microsoft.rdc.macos` | <a href="https://go.microsoft.com/fwlink/?linkid=868963"><img src="/images/windowsapp.png" alt="Download Image" width="80"></a> |
| **Windows App Only Installer** <sup>_(Remote Desktop <img src="/images/microsoft-remote-desktop-logo.png" alt="Remote Desktop" width="15" style="vertical-align: middle; display: inline-block;" />)_</sup><br><a href="https://learn.microsoft.com/en-us/windows-app/whats-new?tabs=macos" style="text-decoration: none;"><small>_Release Notes_</small></a> <sub>_(Does Not Contain MAU)_</sub><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Windows App', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Windows App', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Windows App', 'min_os')}` | `com.microsoft.rdc.macos` | <a href="{get_standalone_package_detail(packages, 'Windows App', 'app_only_update_download')}"><img src="/images/windowsapp.png" alt="Download Image" width="80"></a> |
| **Visual Studio Code Standalone Installer**<br><a href="https://code.visualstudio.com/updates/" style="text-decoration: none;"><small>_Release Notes_</small></a><br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Visual', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Visual', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Visual', 'min_os')}` | `com.microsoft.VSCode` | <a href="https://go.microsoft.com/fwlink/?linkid=2156837"><img src="/images/Code_512x512x32.png" alt="Download Image" width="80"></a>|
...
| **Licensing Helper Tool Installer**<br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Licensing Helper Tool', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Licensing Helper Tool', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Licensing Helper Tool', 'min_os')}` | N/A | <a href="{get_standalone_package_detail(packages, 'Licensing Helper Tool', 'full_update_download')}"><img src="/images/pkg-icon.png" alt="Download Image" width="80"></a>|
| **Quick Assist Installer**<br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Quick Assist', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Quick Assist', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Quick Assist', 'min_os')}` | `com.microsoft.quickassist` | <a href="{get_standalone_package_detail(packages, 'Quick Assist', 'full_update_download')}"><img src="/images/quickassist.png" alt="Download Image" width="80"></a>|
| **Remote Help Installer**<br><br>Last Update:<br>`{get_standalone_package_detail(packages, 'Remote Help', 'last_updated')}` | Version:<br>`{get_standalone_package_detail(packages, 'Remote Help', 'short_version')}`<br><br>Min OS:<br>`{get_standalone_package_detail(packages, 'Remote Help', 'min_os')}` | `com.microsoft.remotehelp` | <a href="{get_standalone_package_detail(packages, 'Remote Help', 'full_update_download')}"><img src="/images/remotehelp.png" alt="Download Image" width="80"></a>|
