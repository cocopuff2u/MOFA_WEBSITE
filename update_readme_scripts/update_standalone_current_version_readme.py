...
| **Product Package** | **CFBundle Version** | **CFBundle Identifier** | **Download** |
|----------------------|----------------------|--------------------------|--------------|
| **Word** <sup>365/2021/2024</sup> **Standalone Installer** | `{get_standalone_package_detail(packages, 'Word', 'short_version')}` | com.microsoft.word | <a href="{get_standalone_package_detail(packages, 'Word', 'update_download')}"><img src=".github/images/MSWD_512x512x32.png" alt="Download Image" width="80"></a> |
