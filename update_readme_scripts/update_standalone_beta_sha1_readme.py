...
|----------------------|----------|------------------|
| **Word** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'Word', 'update_download')}"><img src="/images/Word_beta.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Word', 'sha1')}` |
| **Excel** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'Excel', 'update_download')}"><img src="/images/Excel_beta.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Excel', 'sha1')}` |
| **PowerPoint** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'PowerPoint', 'update_download')}"><img src="/images/PowerPoint_beta.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'PowerPoint', 'sha1')}` |
| **Outlook** (365/2021/2024) **Standalone Installer**| <a href="{get_standalone_package_detail(packages, 'Outlook', 'update_download')}"><img src="/images/Outlook_beta.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Outlook', 'sha1')}` |
| **OneNote** (365/2021/2024) **Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'OneNote', 'update_download')}"><img src="/images/OneNote_beta.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'OneNote', 'sha1')}` |
| **Teams Standalone Installer** | <a href="{get_standalone_package_detail(packages, 'Teams', 'update_download')}"><img src="/images/Teams_beta.webp" alt="Download Image" width="60"></a> | `{get_standalone_package_detail(packages, 'Teams', 'sha1')}` |
